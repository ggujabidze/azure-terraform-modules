...
| <a name="input_use_32_bit_worker"></a> [use\_32\_bit\_worker](#input\_use\_32\_bit\_worker) | Should the Windows Function App use a 32-bit worker process | `bool` | `true` | no |
