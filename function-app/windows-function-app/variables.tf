...
variable "auth_settings_enabled" {
  description = "(Required) Should the Authentication / Authorization feature is enabled for the Windows Function App be enabled?"
  type        = bool
  default     = false
}
...
variable "allowed_external_redirect_urls" {
  description = "(Optional) Specifies a list of External URLs that can be redirected to as part of logging in or logging out of the Windows Function App."
  type        = list(string)
  default     = null
}
...
variable "issuer" {
  description = "(Optional) The OpenID Connect Issuer URI that represents the entity which issues access tokens for this Windows Function App."
  type        = string
  default     = null
}

variable "runtime_version" {
  description = "(Optional) The RuntimeVersion of the Authentication / Authorization feature in use for the Windows Function App."
  type        = string
  default     = null
}
...
variable "token_store_enabled" {
  description = "(Optional) Should the Windows Function App durably store platform-specific security tokens that are obtained during login flows?"
  type        = bool
  default     = false
}
...
#############################
variable "always_on" {
  description = "If this Windows Function App is Always On enabled"
  type        = bool
  default     = false
}
...
variable "is_manual_connection" {
  description = "(Required) Does the Private Endpoint require Manual Approval from the remote resource owner? If you are trying to connect the Private Endpoint to a remote resource without having the correct RBAC permissions on the remote resource set this value to true."
  type        = bool
  default     = false
}

variable "private_connection_resource_alias" {
  description = "(Optional) The Service Alias of the Private Link Enabled Remote Resource which this Private Endpoint should be connected to. One of private_connection_resource_id or private_connection_resource_alias must be specified."
  type        = string
  default     = null
}
...
variable "subresource_name" {
  description = "(Required) Specifies the subresource this IP address applies to. subresource_names corresponds to group_id. Changing this forces a new resource to be created."
  type        = string
  default     = null
}

variable "member_name" {
  description = "(Optional) Specifies the member name this IP address applies to. If it is not specified, it will use the value of subresource_name."
  type        = string
  default     = null
}