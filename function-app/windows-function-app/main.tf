...
resource "azurerm_windows_function_app" "my_windows_function_app" {
  ...
  site_config {
    ...
    dynamic "application_stack" {
      ...
      content {
        ...
        use_dotnet_isolated_runtime = lookup(local.app_stack, "use_dotnet_isolated_runtime", null)
...
resource "azurerm_private_endpoint" "my_private_ep" {
  name                          = "${azurerm_windows_function_app.my_windows_function_app.name}-pe"
  resource_group_name           = var.resource_group_name
  location                      = var.location
  ...
  private_service_connection {
    name                              = "${azurerm_windows_function_app.my_windows_function_app.name}-service-connection"
    is_manual_connection              = var.is_manual_connection
    private_connection_resource_id    = azurerm_windows_function_app.my_windows_function_app.id
