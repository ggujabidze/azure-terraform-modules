# Windows Web App
resource "azurerm_windows_web_app" "my_windows_web_app" {
    ...
    dynamic "auto_heal_setting" {
      ...
      content {
        dynamic "action" {
          ...
          content {
            ...
            dynamic "custom_action" {
              for_each = var.custom_action_executable != null ? [1] : []
              content {
                executable = var.custom_action_executable
                parameters = var.custom_action_parameters
              }
            }
          }
        }
        dynamic "trigger" {
          ...
          content {
            private_memory_kb = var.private_memory_kb
