...
variable "docker_image" {
  description = "(Optional) The Docker image reference, including repository host as needed."
  type        = string
  default     = null
}

variable "docker_image_tag" {
  description = "(Optional) The image Tag to use. e.g. latest."
  type        = string
  default     = null
}
...
variable "java_server" {
  description = "(Optional) The Java server type. Possible values include JAVA, TOMCAT, and JBOSSEAP. JBOSSEAP requires a Premium Service Plan SKU to be a valid option."
  type        = string
  default     = null
}

variable "java_server_version" {
  description = "(Optional) The Version of the java_server to use."
  type        = string
  default     = null
}

variable "java_version" {
  description = "(Optional) The Version of Java to use. Supported versions of Java vary depending on the java_server and java_server_version, as well as security and fixes to major versions. Please see Azure documentation for the latest information."
  type        = string
  default     = null
}

variable "node_version" {
  description = "(Optional) The version of Node to run. Possible values include 12-lts, 14-lts, and 16-lts. This property conflicts with java_version."
  type        = string
  default     = null
}

variable "php_version" {
  description = "(Optional) The version of PHP to run. Possible values include 7.4, and 8.0."
  type        = string
  default     = null
}

variable "python_version" {
  description = "(Optional) The version of Python to run. Possible values include 3.7, 3.8, 3.9 and 3.10."
  type        = string
  default     = null
}

variable "ruby_version" {
  description = "(Optional) Te version of Ruby to run. Possible values include 2.6 and 2.7."
  type        = string
  default     = null
}
...
variable "auth_settings_enabled" {
  description = "(Required) Should the Authentication / Authorization feature is enabled for the Linux Web App be enabled?"
  type        = bool
  default     = false
}
...
variable "allowed_external_redirect_urls" {
  description = "(Optional) Specifies a list of External URLs that can be redirected to as part of logging in or logging out of the Linux Web App."
  type        = list(string)
  default     = null
}
...
variable "issuer" {
  description = "(Optional) The OpenID Connect Issuer URI that represents the entity which issues access tokens for this Linux Web App."
  type        = string
  default     = null
}

variable "runtime_version" {
  description = "(Optional) The RuntimeVersion of the Authentication / Authorization feature in use for the Linux Web App."
  type        = string
  default     = null
}
...
variable "token_store_enabled" {
  description = "(Optional) Should the Linux Web App durably store platform-specific security tokens that are obtained during login flows?"
  type        = bool
  default     = false
}
...
variable "minimum_process_execution_time" {
  description = "(Optional) The minimum amount of time in hh:mm:ss the Linux Web App must have been running before the defined action will be run in the event of a trigger."
  type        = string
  default     = null
}
...
variable "web_app_identity_type" {
  description = "(Required) Specifies the type of Managed Service Identity that should be configured on this Linux Web App. Possible values are SystemAssigned, UserAssigned, SystemAssigned, UserAssigned (to enable both)."
  type        = string
  default     = null
}

variable "web_app_identity_id" {
  description = "(Optional) A list of User Assigned Managed Identity IDs to be assigned to this Linux Web App. This is required when type is set to UserAssigned or SystemAssigned, UserAssigned."
  type        = list(string)
  default     = []
}
...
#############################
variable "always_on" {
  description = "(Optional) If this Linux Web App is Always On enabled. Must be explicitly set to false when using Free, F1, D1, or Shared Service Plans."
  type        = bool
  default     = false
}

variable "api_definition_url" {
  description = "(Optional) The URL to the API Definition for this Linux Web App."
  type        = string
  default     = null
}

variable "api_management_api_id" {
  description = "(Optional) The API Management API ID this Linux Web App Slot is associated with."
  type        = string
  default     = null
}
...
variable "scm_use_main_ip_restriction" {
  description = "(Optional) Should the Linux Web App ip_restriction configuration be used for the SCM also."
  type        = bool
  default     = false
}
